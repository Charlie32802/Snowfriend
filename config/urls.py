...
# Import custom secure admin site
from accounts.admin import admin_site

urlpatterns = [
    # =============================================================================
    # SECURE ADMIN - Custom URL (Keep this SECRET!)
    # =============================================================================
    path('admin-032802/', admin_site.urls),  # Custom secure admin
    
    # =============================================================================
    # DEFAULT ADMIN - Disabled for security
    # Uncomment ONLY if you need Django's default admin for other apps
    # =============================================================================
