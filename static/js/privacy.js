document.addEventListener('DOMContentLoaded', () => {
    ...
    // ============================================
    // FEEDBACK LINK EVENT LISTENER
    // ============================================

    // Find all links with onclick containing "transitionToFeedbackModal"
    // This is a more reliable way than inline onclick
    document.addEventListener('click', (e) => {
        const target = e.target.closest('a[href*="Contact"], a.privacy-link');
        if (target && target.textContent.includes('Share your feedback')) {
            e.preventDefault();
            e.stopPropagation();
